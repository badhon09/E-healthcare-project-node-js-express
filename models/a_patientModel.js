...
/*	update: function(patient, callback){
		...
		var sql = "update users SET fullname='"+patient.fullname+"' email = '"+patient.email+"',password = '"+patient.password+"',contactno = '"+patient.contactno+"'  WHERE user_id='"+patient.id+"'";
		db.getResults(sql, function(results1){
			//callback(results1);
		});
		
		var sql = "update patient_info SET p_address = '"+patient.p_address+"',p_bmi = '"+patient.p_bmi+"',p_weight = '"+patient.p_weight+"', p_blood_p = '"+patient.p_blood_p+"', p_cal_in = '"+patient.p_cal_in+"' WHERE user_id='"+patient.id+"'";
		db.getResults(sql, function(results){
		callback(results);
	...
	*/
	...
	updateP: function(patient, callback){
		console.log('patients.............',patient);
		var sql = "update users set fullname = '"+patient.fullname+"', username = '"+patient.username+"',email = '"+patient.email+"', password = '"+patient.password+"',contactno = '"+patient.contactno+"' where user_id = '"+patient.id+"'";
