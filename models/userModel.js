...
module.exports= {
	...
	deleteService: function(service,callback){
		var sql = "DELETE FROM service WHERE service_id = '"+service.id+"'";
		db.getResults(sql, function(results){
			callback(results);
		});
	},
	...
	updateDoc: function(admin, callback){
		console.log(admin);
		var sql = "update users set fullname = '"+admin.fullname+"', username = '"+admin.username+"',email = '"+admin.email+"', password = '"+admin.password+"',contactno = '"+admin.contactno+"' where user_id = '"+admin.id+"'";
		//var sql = "INSERT INTO users(fullname,username,email,password,type,photo,contactno) VALUES ('"+admin.fullname+"','"+admin.username+"','"+admin.email+"','"+admin.password+"','"+admin.type+"','"+admin.photo+"','"+admin.contactno+"')";
	...
	updateConsulting: function(id, callback){
		//console.log(admin);
		var sql = "update consulting set status = 'accept' where c_id = '"+id+"'";
		//var sql = "INSERT INTO users(fullname,username,email,password,type,photo,contactno) VALUES ('"+admin.fullname+"','"+admin.username+"','"+admin.email+"','"+admin.password+"','"+admin.type+"','"+admin.photo+"','"+admin.contactno+"')";
	...
	updateConsultingR: function(id, callback){
		//console.log(admin);
		var sql = "update consulting set status = 'reject' where c_id = '"+id+"'";
		//var sql = "INSERT INTO users(fullname,username,email,password,type,photo,contactno) VALUES ('"+admin.fullname+"','"+admin.username+"','"+admin.email+"','"+admin.password+"','"+admin.type+"','"+admin.photo+"','"+admin.contactno+"')";
