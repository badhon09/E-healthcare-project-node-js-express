...
router.get('/servicerequest/delete/:id',(req,res)=>{

    var service={
        id:req.params.id
        
    }
    userModel.deleteService(service,function(status){
        if(status){
            res.redirect('/admin/servicerequest');
        }
...
(req,res)=>{
    ...
    if(req.files){
       ...
       // console.log("fileeeeeeeeeeeeeeeeeeeeeeeeeeeee",image);
...
router.get('/consultingrequest/accept/:id',(req,res)=>{

   id=req.params.id;
    
    userModel.updateConsulting(id,function(results){
      
      
        res.redirect('/admin/consultingrequest');
    });
...
router.get('/consultingrequest/reject/:id',(req,res)=>{

    id=req.params.id;
     
     userModel.updateConsultingR(id,function(results){
...
router.post('/patients/edit/:id',(req,res)=>{
    var patient = {  username:req.body.username,
        ...
        //console.log('mmmmmmmmmmmmmm',patient);

                            patientModel.updateP(patient,function(results){
...
router.post('/doctors/edit/:id',(req,res)=>{
    ...
    var doctor = {username:req.body.username,
        ...
        contactno:req.body.contactno};
                            ...
                            userModel.updateDoc(doctor,function(results){
                               // console.log('db results---------->',results);
                                if(results){
                                    res.redirect('/admin/doctors');
